...
/**
 * Base static class for performing query and update operations on the 'weblog_comment' table.
 *
 * 
 *
 * This class was autogenerated by Propel 1.3.0-dev on:
 *
 * Fri May  3 17:55:04 2013
 *
...
abstract class BaseCommentPeer {
	...
	const TABLE_NAME = 'weblog_comment';
	...
	const ID = 'weblog_comment.ID';

	/** the column name for the POST_ID field */
	const POST_ID = 'weblog_comment.POST_ID';

	/** the column name for the AUTHOR field */
	const AUTHOR = 'weblog_comment.AUTHOR';

	/** the column name for the EMAIL field */
	const EMAIL = 'weblog_comment.EMAIL';

	/** the column name for the BODY field */
	const BODY = 'weblog_comment.BODY';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'weblog_comment.CREATED_AT';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'postId', 'author', 'email', 'body', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::POST_ID, self::AUTHOR, self::EMAIL, self::BODY, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'postId' => 1, 'author' => 2, 'email' => 3, 'body' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::POST_ID => 1, self::AUTHOR => 2, self::EMAIL => 3, self::BODY => 4, self::CREATED_AT => 5, ),
	...
	public static function doCountJoinPost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CommentPeer::POST_ID,), array(PostPeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPost(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
    ...
    foreach (sfMixer::getCallables('BaseCommentPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCommentPeer', $c, $con);
		...
		$c->addJoin(array(CommentPeer::POST_ID,), array(PostPeer::ID,), $join_behavior);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the weblog_comment table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
