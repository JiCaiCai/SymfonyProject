...
abstract class BaseTeacher extends BaseObject  implements Persistent {
  ...
  const PEER = 'TeacherPeer';
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = TeacherPeer::TYPE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TeacherPeer::NUM_COLUMNS - TeacherPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(TeacherPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TeacherPeer::TYPE)) $criteria->add(TeacherPeer::TYPE, $this->type);
	 ...
	 * related Students from storage. If this Teacher is new, it will return
		...
		if ($this->collStudents === null) {
			if ($this->isNew()) {
			   $this->collStudents = array();
				...
				$criteria->add(StudentPeer::TEACHER_ID, $this->id);
