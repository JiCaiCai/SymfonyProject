  ...
  const PEER = 'StudentPeer';
	...
	public function setTeacherId($v)
	{
		...
		if ($this->teacher_id !== $v) {
			$this->teacher_id = $v;
			$this->modifiedColumns[] = StudentPeer::TEACHER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->grade = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = StudentPeer::NUM_COLUMNS - StudentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setGrade($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StudentPeer::TEACHER_ID)) $criteria->add(StudentPeer::TEACHER_ID, $this->teacher_id);
	...
	public function getTeacher(PropelPDO $con = null)
	{
		if ($this->aTeacher === null && ($this->teacher_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTeacher->addStudents($this);
			 */
		}
