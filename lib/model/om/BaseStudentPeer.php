...
abstract class BaseStudentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Grade', 'TeacherId', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'grade', 'teacherId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::GRADE, self::TEACHER_ID, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'grade', 'teacher_id', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Grade' => 2, 'TeacherId' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'grade' => 2, 'teacherId' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::GRADE => 2, self::TEACHER_ID => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'grade' => 2, 'teacher_id' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StudentPeer::TEACHER_ID);
	...
	public static function doCountJoinTeacher(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(StudentPeer::TEACHER_ID,), array(TeacherPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Student objects pre-filled with their Teacher objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseStudentPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseStudentPeer', $c, $con);
		...
		$c->addJoin(array(StudentPeer::TEACHER_ID,), array(TeacherPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Student) to $obj2 (Teacher)
      ...
      call_user_func($callable, 'BaseStudentPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Student) to the collection in $obj2 (Teacher)
				$obj2->addStudent($obj1);
